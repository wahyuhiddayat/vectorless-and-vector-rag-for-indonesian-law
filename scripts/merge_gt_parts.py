...
def main() -> None:
    ...
    ap.add_argument("--out", type=str, default=None, help="Output file path (default: data/ground_truth_raw/<doc_id>.json)")
    ...
    output_path = Path(args.out) if args.out else (DEFAULT_RAW_DIR / f"{args.doc_id}.json")
